...
ActiveRecord::Schema.define(version: 20170116163921) do
  ...
  create_table "lccn_records", force: :cascade do |t|
    ...
    t.datetime "created_at",       null: false
    t.datetime "updated_at",       null: false
    t.index ["body"], name: "index_lccn_records_on_body", unique: true, using: :btree
    t.index ["manifestation_id"], name: "index_lccn_records_on_manifestation_id", using: :btree
  end
